    ...
    <div className="rounded-2xl bg-white p-8 text-center">
      ...
      <div className="flex justify-center space-x-4">
        ...
        {showUploadButton && uploadUrl && (
          <Link
            href={uploadUrl}
            className="inline-flex items-center rounded-lg bg-linear-to-r from-blue-700 to-blue-600 px-4 py-2 text-sm font-medium text-white hover:from-blue-800 hover:to-blue-700 focus:outline-none focus:ring-blue-500 focus:ring-offset-2 transition-all duration-300 shadow-md hover:shadow-lg"
          >

...
const CreateEventModal = ({ isOpen, onClose, onSave }: CreateEventModalProps) => {
  ...
  const handleSave = async () => {
    if (!title.trim() || !date || !time || !location.trim() || !image) {
      toast.error('Please fill in all required fields and upload an event flyer');
      return;
    }
            ...
            <div className="relative p-6">
              ...
              <div className="mb-5 flex justify-between items-center">
                <div className="flex items-center">
                  ...
                  <h3 className="text-lg font-medium flex items-center">
                    <span className="text-blue-700 mr-2">Create</span>
                  ...
                  <div className="relative">
                    ...
                    <div className="border-2 border-dashed border-gray-300 rounded-lg p-6 text-center hover:border-blue-400 transition-colors">
                      ...
                      <p className="text-sm text-gray-600">
                        {image ? image.name : 'Click to upload event flyer or drag & drop'}
                      </p>
              ...
              <div className="flex justify-end space-x-3">
                ...
                <button
                  ...
                  onClick={handleSave}
                  disabled={
                    isSaving || !title.trim() || !date || !time || !location.trim() || !image
                  }
                ...
                >
                  {isSaving ? (
                    <>
                      ...
                      {isUploadingImage ? 'Uploading Flyer...' : 'Creating...'}
                    </>
                  ) : (
                    <>
